...
if __name__ == "__main__":
    ...
    list_bq_table_columns(project_id, dataset_name, table_name)
    apply_columns = list(map(str, input("Enter the apply columns from above list with comma seperator: ").split(",")))
    ...
    if taxonomy_id:
        list_policy_tags(taxonomy_id)
        apply_policy_tags = list(map(str, input("Enter policy tags from above list with comma seperator wrt columns: ").split(",")))
