...
from helpers.test_ingest_data import ingest_data
import json
...
CONFIGS_PATH = f"gs://{CONFIGS_BUCKET_NAME}/employee_data/employee_data.yaml"
DATAPLEX_TASK_ID = "employee-data-dag"
DATA_LAKE = 'hr-lake'
# output table data
GCP_PROJECT_ID = "hca-usr-hin-proc-datalake"
GCP_BQ_DATASET_ID = "hca_landing_employee_data_dq_output"
...
with models.DAG(
    ...
    move_incremental_data_task = BranchPythonOperator(
...
start_op >> move_incremental_data_task >> get_dataplex_task
