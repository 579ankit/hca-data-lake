...
DATE_PATTERN = r'\d{12}'
FOLDER_PREFIX = 'floor_skill_association/'
...
dag = DAG(
    'batch_ingest_floor_skill_association',
    default_args=default_args,
    description='DAG to move floor skill association in landing layer',
    schedule_interval=None,
)

move_incremental_data_task = PythonOperator(
    task_id='batch_ingest_floor_skill_association',
